...
## UnicodeCharacter.Inequality (Operator)

> **Namespace**: [Heirloom][0]  
> **Declaring Type**: [UnicodeCharacter][1]

### Inequality(UnicodeCharacter, UnicodeCharacter)

Implements the inequality operator.

```cs
public static bool Inequality(UnicodeCharacter left, UnicodeCharacter right)
```
