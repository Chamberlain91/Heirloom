...
namespace Heirloom.Sound
{
    ...
    public sealed class AudioSource : AudioNode
    {
        ...
        /// <seealso cref="Length"/>
        public float Time => Position < 0 ? 0 : Position / (float) (AudioBackend.SampleRate * AudioBackend.Channels);
        ...
        /// <seealso cref="Position"/>
        /// <seealso cref="Length"/>
        public float Duration => Length == 0 ? 0 : Length / (float) (AudioBackend.SampleRate * AudioBackend.Channels);
        ...
        {
            Seek((int) (time * AudioBackend.SampleRate * AudioBackend.Channels));
        }
