...
namespace Heirloom.Sound.Desktop
{
    ...
    internal sealed unsafe class MiniAudioDecoder : IAudioDecoder
    {
        ...
        public MiniAudioDecoder(Stream stream)
        {
            ...
            var config = ma_decoder_config_init(SampleFormat.S16, AudioBackend.Channels, AudioBackend.SampleRate);
        ...
        public int Decode(Span<short> samples)
        {
            ...
            {
                return (int) ma_decoder_read_pcm_frames(_decoder, pSamples, (ulong) (count / AudioBackend.Channels)) * AudioBackend.Channels;
            }
        }
