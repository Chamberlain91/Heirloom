...
{
    public abstract class Application : GraphicsBackend
    {
        ...
        internal override bool SupportsCustomShaders => _backend.SupportsCustomShaders;

        protected internal override object GenerateNativeObject(GraphicsResource resource)
        {
            return _backend.GenerateNativeObject(resource);
        }

        internal override Uniform[] CompileShader(Shader shader)
        {
            return _backend.CompileShader(shader);
        }

        internal override GpuInfo GetGpuInfo()
        {
            return _backend.GetGpuInfo();
        }
        ...
        private static void InitializeGraphics()
        {
            ...
            InitializeRenderingSystems(_backend);
