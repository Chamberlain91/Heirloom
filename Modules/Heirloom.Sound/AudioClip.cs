...
namespace Heirloom.Sound
{
    ...
    public sealed class AudioClip
    {
        ...
        /// </summary>
        public float Duration => Length / (float) (AudioProcessor.Instance.SampleRate * AudioProcessor.Instance.Channels);
        ...
        private static short[] DecodeFiniteStream(Stream stream)
        {
            ...
            else
            {
                ...
                {
                    // Allocate next block
                    var block = new short[BLOCK_SIZE * AudioProcessor.Instance.Channels];
                ...
                var samples = new short[total * AudioProcessor.Instance.Channels];
                ...
                foreach (var block in blocks)
                {
                    ...
                    if (i == (blocks.Count - 1))
                    {
                        blockSize = (int) (total * AudioProcessor.Instance.Channels) % block.Length;
                    }
